      ...
      <Form layout="vertical" autoComplete="off" initialValues={complaint}>
        <Row gutter={16}>
          <Col xs={24} sm={24} md={12} lg={12}>
            ...
            <Form.Item name="event_description" className="formInputBasicInfo">
              Event Description
          ...
          <Col xs={24} sm={24} md={12} lg={12}>
            <Form.Item name="bussiness_division" className="formInputBasicInfo">
              Business Division
            ...
            <Form.Item name="complaint_reviewed_date" className="dateInputTag">
